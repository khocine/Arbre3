...
<!--          <li>Bienvenue Hocine - <a href="#"><i class="fa fa-sign-out"></i> Déconnexion</a></li>-->
		...
		<div class="header_social main_nav">
			<ul>    
				...
				<li>Bienvenue ${clientConnecte.prenom} <a href="User?connexion=toDeconnect"><i class="fa fa-sign-out"></i> Déconnexion</a></li>
                                </c:when>
                                <c:otherwise>
                                <li><a href="User?connexion=start"><i class="fa fa-sign-in"></i> Connexion</a></li>
                                </c:otherwise>
                                </c:choose>
			</ul>
		</div>
